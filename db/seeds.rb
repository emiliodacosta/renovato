...
p2 = Project.create!(zipCode: "19019", intSvcs: true, archSvcs: true, gcSvcs: true, budget: 75000, renovator_id: r1.id)
p3 = Project.create!(zipCode: "11954", intSvcs: true, archSvcs: false, gcSvcs: false, budget: 25000, renovator_id: r1.id)
p4 = Project.create!(zipCode: "11954", intSvcs: true, archSvcs: true, gcSvcs: true, budget: 75000, renovator_id: r1.id)
